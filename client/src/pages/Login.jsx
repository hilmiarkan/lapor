...
export default function Login() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault(e);
    axios
      .post("http://localhost:6809/user/auth", state, {headers: {token : state.token}})
      .then(({ data }) => {
              ...
              <div className="row justify-content-center">
                <div className="col-sm-6">
                  <img
                    ...
                    alt="Logo"
                  />
                  <div className="h3 space-between__h3-logo">Login</div>
                  ...
                  <div className="d-flex flex-row align-items-center">
                    <p className="no-margin">
                      <a href="/register">Saya belum punya akun</a>
                    </p>
                    <button
                      type="submit"
