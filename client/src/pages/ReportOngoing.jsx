...
export default function Login() {
  ...
  useEffect(() => {
    if (!state.token) {
      ...
      axios
        .get(`http://localhost:6809/report/user/ongoing`, {headers: {token : state.token}})
        .then(({ data }) => {
          console.log(data);
          ...
          <ul className="navbar-nav w-100">
            ...
            <li className="nav-item">
              <a className="nav-link active cursor-default" href="#">
                Aduan dalam pengerjaan <span className="sr-only">(current)</span>
              </a>
            </li>
            <li className="nav-item">
                          ...
                          <div className="modal-content">
                            ...
                            <div className="modal-footer">
                              ...
                              <button
                                ...
                                onClick={() =>
                                  updateStatus(element.id_report, "Finished")
                                }
                              >
                                Finish
                              </button>
