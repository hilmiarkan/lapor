  ...
  return (
    <div>
      ...
      <div className="container-fluid">
        <div className="row justify-content-center margin-top__12rem">

          <div className="col-3 card width-card text-white bg-danger mb-3">
            <div className="card-body">
              <h1 className="text-center">
                <strong>{state.pendingReport}</strong>
              </h1>
              <h2 className="text-center">Pending Report</h2>
            </div>
          </div>
          <div className="col-3 card margin-left__3rem width-card text-white bg-success mb-3">
            <div className="card-body">
              <h1 className="text-center">
                <strong>{state.totalReport}</strong>
              </h1>
              <h2 className="text-center">Total Report</h2>
            </div>
          </div>
        </div>
      </div>
